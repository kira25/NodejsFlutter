...
class _MainPageState extends State<MainPage> {
  ...
  Widget build(BuildContext context) {
    ...
    print(productState.getResponseJson());
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Node&Flutter',
      ...
      body: Center(
        child: productState.isFetching ? CircularProgressIndicator() : 
        productState.getResponseJson() != null ? ListView.builder(itemCount: productState.getResponseJson().length,itemBuilder: (context,index){
          return ListTile(
            title: productState.getResponseJson()[index]['name'].toString(),
          );
